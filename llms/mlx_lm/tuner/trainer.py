...
def all_reduce_gradients(gradients):
    ...
    def _all_reduce_avg(x):
        return mx.distributed.all_reduce_sum(x) / world_size

    return tree_map(_all_reduce_avg, gradients)
...
def evaluate(
    ...
    all_losses = mx.distributed.all_reduce_sum(all_losses)
    ntokens = mx.distributed.all_reduce_sum(ntokens)
...
def train(
    ...
    def step(batch):
        ...
        grad = all_reduce_gradients(grad)
